...
AddToChart1
    .append("text")
    .text("Economic Inequality in Finland")  // XXX
    .attr("x", 500)
    .attr("y", 28)
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", overallinequalitycolor)
    .text("Gini coefficient - Taxable income among tax") // XXX 
    .attr("x", 760) // XXX 
    .attr("y", 115); // XXX 
c3.select('#chart2')
    .append("text")
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", topincomecolor)
    .text("Share of top 1% - Post-tax national income") // XXX 
    .attr("x", 760) // XXX 
    .attr("y", 325); // XXX 
c3.select('#chart2')
    .append("text")
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", topincomecolor)
    .text("Share of top 1% - Pre-tax fiscal") // XXX 
    .attr("x", 337) // XXX 
    .attr("y", 333); // XXX 
c3.select('#chart2')
    .append("text")
    .attr("class", "linelabel")
    .style("fill", topincomecolor)
    .text("income (tax-units, individuals) ★") // XXX 
    .attr("x", 337) // XXX 
    .attr("y", 343); // XXX 

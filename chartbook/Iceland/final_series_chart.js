...
var RH_tickMarks = [160, 170, 180, 190] // XXX    100,110,120,130,140,150,160,170,180,190,200,210,220,230,240,250,260,270,280,290,300
...
AddToChart1
    .append("text")
    .text("Economic Inequality in Iceland")  // XXX
    .attr("x", 500)
    .attr("y", 28)
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", earningscolor)
    .text("Gini coefficient - Employment earnings")
    .attr("x", 760)
    .attr("y", 70);


// Overall Inequality Series // XXX
c3.select('#chart2')
    .append("text")
    .attr("class", "linelabel")
    .style("fill", overallinequalitycolor)
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", topincomecolor)
    .text("Share of top 1% - Pre-tax national")
    .attr("x", 350)
    .attr("y", 307);
c3.select('#chart2')
    .append("text")
    .attr("class", "linelabel")
    .style("fill", topincomecolor)
    .text("income (equal-split adults) ★")
    .attr("x", 350)
    .attr("y", 317);
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", povertycolor)
    .text("Share below 60% median - Equivalised disposable household income ★")
    .attr("x", 679)
    .attr("y", 280);
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", povertycolor)
    .text("Share below 50% median - Equivalised")
    .attr("x", 440)
    .attr("y", 260);
c3.select('#chart2')
    .append("text")

...
var RH_tickMarks = [160, 170, 180, 190, 200, 210, 220, 230, 240] // XXX    100,110,120,130,140,150,160,170,180,190,200,210,220,230,240,250,260,270,280,290,300
...
AddToChart1
    .append("text")
    .text("Economic Inequality in Canada")  // XXX
    .attr("x", 500)
    .attr("y", 28)
...
c3.csv("../raw_df.csv", function (data) {
    c3.select('#chart1')
        ...
        .style("fill", earningscolor)
        .text("Top decile as % median - Gross individual earnings ★") // XXX
        .attr("x", 760)
        .attr("y", 160);
})
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", overallinequalitycolor)
    .text("Gini coefficient – Equivalised")
    .attr("x", 550)
    .attr("y", 44);
c3.select('#chart2')
    .append("text")
    .attr("class", "linelabel")
    .style("fill", overallinequalitycolor)
    .text("gross family money income")
    .attr("x", 550)
    .attr("y", 54);
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", overallinequalitycolor)
    .text("Gini coefficient – Equivalised after-tax household")
    .attr("x", 760)
    .attr("y", 112);
c3.select('#chart2')
    .append("text")
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", overallinequalitycolor)
    .text("Gini coefficient – Gross family income for")
    .attr("x", 370)
    .attr("y", 20);
c3.select('#chart2')
    .append("text")
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", povertycolor)
    .text("Share below 50% median - Equivalised disposable")
    .attr("x", 760)
    .attr("y", 270);
c3.select('#chart2')
    .append("text")
